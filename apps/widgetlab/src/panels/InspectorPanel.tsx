        ...
        {stats && (
          <>
            ...
            {stats.ecs.sampleCount > 0 && (
              <div className="border-t border-neutral-100 pt-2 dark:border-neutral-700">
                <div className={`${sectionCls} text-neutral-600 dark:text-neutral-400`}>ECS Tick</div>
            ...
            {stats.r3f.sampleCount > 0 && (
              <div className="border-t border-neutral-100 pt-2 dark:border-neutral-700">
                <div className={`${sectionCls} text-neutral-600 dark:text-neutral-400`}>R3F Canvas</div>
                <BudgetBar
