...
function ShapesView({ entity, world }: WidgetComponentProps): ReactElement {
  const props = useWidgetProps<ShapesProps>(world, entity, "shapes-card");
...
const propsGroup = ShapesCard.groups.find((g) => g.name === "props") as (typeof ShapesCard.groups)[number];
