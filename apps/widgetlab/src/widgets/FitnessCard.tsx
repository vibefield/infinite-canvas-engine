...
function FitnessView({ entity, world }: WidgetComponentProps): ReactElement {
  const props = useWidgetProps<FitnessProps>(world, entity, "fitness-card");
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          <div className="text-[10px] font-semibold uppercase tracking-wider text-white/60">Activity</div>
      ...
      <div className="flex items-stretch justify-between gap-3 border-white/10 border-t pt-3">
        ...
        <Stat label="Exercise" value={exercise.current} goal={exercise.goal} unit="MIN" color="#92E82A" />
