 ...
 * from the card-board demo — the storage contract is app-side and identical here.
 */
import type { AutosaveStorageRead, AutosaveStorageWrite } from "@ice/core";

export interface GlboardStorage extends AutosaveStorageRead, AutosaveStorageWrite {
...
export function createLocalStorageStorage(key: string): GlboardStorage {
  return {
